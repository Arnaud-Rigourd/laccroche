...
# 1. MUSIC
music_1 = Project.create!(category: Project::CATEGORIES[0], title: "Always With You", collab: "#{artwork_artist.nickname} and #{motion_design_artist.nickname}", video_url: "", music_url: "https://open.spotify.com/track/1JBqbYJKV57GBuSLl3j3TN?si=32460687f8a84bcd", user_id: music_video_artist.id, description: lorem_ipsum_medium)
music_2 = Project.create!(category: Project::CATEGORIES[0], title: "Salt Lake Seagull", collab: "#{artwork_artist.nickname} and #{motion_design_artist.nickname}", video_url: "", music_url: "https://open.spotify.com/track/4WvAR6CHlqVjbUupNjkmcb?si=581fa21f49db4649", user_id: music_video_artist.id, description: lorem_ipsum_medium)
music_3 = Project.create!(category: Project::CATEGORIES[0], title: "Heavy Heart", collab: "#{artwork_artist.nickname} and #{motion_design_artist.nickname}", video_url: "", music_url: "https://open.spotify.com/track/2iqXKIikPBMKMrIISWVEEE?si=8373d914b76a43d1", user_id: music_video_artist.id, description: lorem_ipsum_medium)
music_4 = Project.create!(category: Project::CATEGORIES[0], title: "Ghetto Dreamin'", collab: artwork_artist.nickname, video_url: "", music_url: "https://open.spotify.com/track/2ETiOcuJDgUwaXLNZKnZrM?si=29873eb34b0b4ccc", user_id: music_video_artist.id, description: lorem_ipsum_medium)
music_5 = Project.create!(category: Project::CATEGORIES[0], title: "Between The Waves", collab: "", video_url: "", music_url: "https://open.spotify.com/track/5lz7FCk3apkROsI6hctQLU?si=5e2a84d453ff4acc", user_id: music_video_artist.id, description: lorem_ipsum_medium)

# 2. VIDEO ART
video_1 = Project.create!(category: Project::CATEGORIES[1], title: "Flying in the Sky", collab: music_video_artist.nickname, video_url: "https://youtu.be/9Z4TiA5JH_0", music_url: "", user_id: motion_design_artist.id, description: lorem_ipsum_medium)
...
tesseract = Project.new(category: Project::CATEGORIES[2], title: "Tesseract", collab: music_video_artist.nickname, video_url: "", music_url: "", user_id: artwork_artist.id, description: lorem_ipsum_medium)
tesseract.photo.attach(io: tesseract_file, filename: "artwork-tesseract.webp", content_type: "image/webp")
tesseract.save!

hyperspace = Project.new(category: Project::CATEGORIES[2], title: "Hyperspace", collab: music_video_artist.nickname, video_url: "", music_url: "", user_id: artwork_artist.id, description: lorem_ipsum_medium)
hyperspace.photo.attach(io: hyperspace_file, filename: "artwork-hyperspace.webp", content_type: "image/webp")
hyperspace.save!

planetarium = Project.new(category: Project::CATEGORIES[2], title: "Planetarium", collab: music_video_artist.nickname, video_url: "", music_url: "", user_id: artwork_artist.id, description: lorem_ipsum_medium)
planetarium.photo.attach(io: planetarium_file, filename: "artwork-planetarium.webp", content_type: "image/webp")
planetarium.save!

moon = Project.new(category: Project::CATEGORIES[2], title: "Planetarium", collab: music_video_artist.nickname, video_url: "", music_url: "", user_id: artwork_artist.id, description: lorem_ipsum_medium)
...
Like.create!(user_id: motion_design_artist.id, project_id: music_1.id)
Like.create!(user_id: artwork_artist.id, project_id: music_1.id)

Like.create!(user_id: music_video_artist.id, project_id: music_2.id)
Like.create!(user_id: artwork_artist.id, project_id: music_2.id)

Like.create!(user_id: motion_design_artist.id, project_id: music_3.id)

Like.create!(user_id: motion_design_artist.id, project_id: music_4.id)
Like.create!(user_id: artwork_artist.id, project_id: music_4.id)

Like.create!(user_id: music_video_artist.id, project_id: music_5.id)
Like.create!(user_id: motion_design_artist.id, project_id: music_5.id)
Like.create!(user_id: artwork_artist.id, project_id: music_5.id)

Like.create!(user_id: motion_design_artist.id, project_id: video_1.id)
Like.create!(user_id: artwork_artist.id, project_id: video_1.id)

Like.create!(user_id: music_video_artist.id, project_id: video_2.id)

Like.create!(user_id: motion_design_artist.id, project_id: tesseract.id)
Like.create!(user_id: artwork_artist.id, project_id: tesseract.id)

Like.create!(user_id: motion_design_artist.id, project_id: hyperspace.id)

Like.create!(user_id: motion_design_artist.id, project_id: planetarium.id)
Like.create!(user_id: artwork_artist.id, project_id: planetarium.id)

Like.create!(user_id: music_video_artist.id, project_id: moon.id)
Like.create!(user_id: motion_design_artist.id, project_id: moon.id)
Like.create!(user_id: artwork_artist.id, project_id: moon.id)

# Like.create!(user_id: music_video_artist.id, project_id: 17)

# Like.create!(user_id: music_video_artist.id, project_id: 18)
# Like.create!(user_id: motion_design_artist.id, project_id: 18)
# Like.create!(user_id: artwork_artist.id, project_id: 18)

# Like.create!(user_id: motion_design_artist.id, project_id: 21)
# Like.create!(user_id: artwork_artist.id, project_id: 21)
# Like.create!(user_id: music_video_artist.id, project_id: 22)
# Like.create!(user_id: artwork_artist.id, project_id: 22)
# Like.create!(user_id: motion_design_artist.id, project_id: 23)

# Like.create!(user_id: motion_design_artist.id, project_id: 24)
# Like.create!(user_id: artwork_artist.id, project_id: 24)

# Like.create!(user_id: motion_design_artist.id, project_id: 25)

# Like.create!(user_id: motion_design_artist.id, project_id: 26)
# Like.create!(user_id: artwork_artist.id, project_id: 26)

# Like.create!(user_id: music_video_artist.id, project_id: 27)
# Like.create!(user_id: artwork_artist.id, project_id: 27)
# Like.create!(user_id: motion_design_artist.id, project_id: 27)

# Like.create!(user_id: music_video_artist.id, project_id: 30)
# Like.create!(user_id: motion_design_artist.id, project_id: 30)
